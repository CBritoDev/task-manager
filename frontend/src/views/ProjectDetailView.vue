    ...
    <div class="max-w-7xl mx-auto p-6 md:p-8">
        <div class="mb-8">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                ...
                <button class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-5 rounded-lg transition-colors">+ Nova Tarefa</button>
            </div>
        </div>
        ...
        <div class="bg-white p-4 rounded-xl border border-gray-200 shadow-sm mb-8 flex flex-col sm:flex-row gap-4">
            <div class="flex-1">
                ...
                <select v-model="filterStatus" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border bg-gray-50">
            ...
            <div class="flex-1">
                ...
                <select v-model="filterPriority" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border border-gray-50">
