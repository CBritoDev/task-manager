...
<template>
    <div
    class="bg-white border rounded-xl p-5 transition-all flex flex-col h-full"
    ...
    <!-- Badge de Atraso--->>
        <span v-if="isOverdue" class="bg-red-100 text-red-700 text-[10px] px-2 py-1 rounded-full font-bold uppercase tracking-wider flex items-center whitespace-nowrap ml-2">
            Atrasada
        </span>
